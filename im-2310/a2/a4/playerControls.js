...
/* Rewind&Forward video 5 seconds */
/* I have picked rewind and forward 5 second as my chosen feature because it allows the user to go back to an earlier or certain part
of the video and the forward button can allow user to skip unwanted parts of the video, making it simpler and locate a specific segment of the video
saving time and efforts. */

function forwardRewind(param) {
  var videoPlayer = document.getElementById("videoElement");
  videoElement.currentTime += param;
